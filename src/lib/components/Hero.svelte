  ...
  <div class="max-w-[1400px] mx-auto">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
      <div class="lg:col-span-7">
        <h1 class="font-serif text-5xl md:text-6xl lg:text-[64px] leading-[1.1] tracking-tight text-gray-900">
          Convert crypto social chatter into structured intelligence
        </h1>
      </div>
      <div class="lg:col-span-5 flex flex-col justify-between">
        <p class="text-gray-500 text-lg max-w-md leading-relaxed">
          Track KOL signals in real-time and capture what matters before tokens move. Never miss another alpha buried in social noise.
        </p>
      </div>
    </div>
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 mb-8 border-t border-gray-200 pt-6">
      <div class="flex items-center gap-4">
        <a href="https://fruitdatalabs.xyz/v2" class="bg-black text-white px-6 py-3 rounded text-sm font-medium hover:bg-gray-800 transition-colors">
          Access Beta
        </a>
        <span class="text-xs text-gray-500 max-w-[120px] leading-tight">
          Live beta platform now available
        </span>
      </div>
    ...
    <div class="relative w-full h-[600px] overflow-hidden rounded-sm bg-primary-800">
      <!-- Image Overlay -->
      <img 
        src="/generated/image-abstract-data-visualization-with-flowing-1765561332495-0.webp" 
